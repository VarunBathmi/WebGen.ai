  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        className={`w-full h-12 ${icon ? "pl-10" : "pl-4"} pr-4 rounded-xl bg-white/5 border border-white/10 text-white text-sm placeholder:text-zinc-600 outline-none focus:border-purple-500/50 transition-colors duration-200`}
      />
    </div>
  );
};
          ...
          >
            <div className="relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden">
              ...
              <div className="relative px-8 pt-10 pb-10 text-center">
                {/* Badge */}
                <h1 className="inline-block mb-5 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs text-zinc-300">
                ...
                <p className="text-zinc-500 text-sm mb-6">
                  Join GenWeb.ai and start building today
                </p>
