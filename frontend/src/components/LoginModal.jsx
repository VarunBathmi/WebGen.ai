...
//         z-[100] flex items-center justify-center bg-black/80 backdrop-blur-xl px-4"
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
//           exit={{ opacity: 0 }}
//           onClick={() => onClose()}
...
//              bg-gradient-to-r from-purple-500/40 via-blue-500/30 to-transparent"
//           >
//             <div
...
const LoginModal = ({ open, onClose }) => {
  ...
  const handleGoogleAuth = async () => {
    try {
      ...
      // ✅ silently ignore cancelled popup (user opened it twice fast)
      if (error?.code === "auth/cancelled-popup-request") return;

      // ✅ silently ignore user manually closing the popup
